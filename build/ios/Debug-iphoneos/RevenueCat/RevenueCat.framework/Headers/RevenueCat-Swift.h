...
typedef SWIFT_ENUM_NAMED(NSInteger, RCAttributionNetwork, "AttributionNetwork", closed) {
/// Apple’s search ads
...
typedef SWIFT_ENUM_NAMED(NSInteger, RCCacheFetchPolicy, "CacheFetchPolicy", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, RCPurchasesErrorCode, "ErrorCode", closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, RCIntroEligibilityStatus, "IntroEligibilityStatus", closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, RCPackageType, "PackageType", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, RCPeriodType, "PeriodType", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, RCPurchaseOwnershipType, "PurchaseOwnershipType", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, RCRefundRequestStatus, "RefundRequestStatus", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, RCStore, "Store", closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, RCStoreProductCategory, "ProductCategory", closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, RCStoreProductType, "ProductType", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, RCPaymentMode, "PaymentMode", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, RCDiscountType, "DiscountType", closed) {
/// Introductory offer
...
typedef SWIFT_ENUM_NAMED(NSInteger, RCSubscriptionPeriodUnit, "Unit", closed) {
